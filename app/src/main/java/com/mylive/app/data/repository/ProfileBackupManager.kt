...
class ProfileBackupManager @Inject constructor(
    ...
    private val settingEntries = listOf(
        ...
        int(SettingsDataStore.DanmuLineCount, 0),
        ...
        int(SettingsDataStore.DanmuDedupeWindow, 20),
        int(SettingsDataStore.DanmuDedupeStep, 3),
        ...
        bool(SettingsDataStore.PlayerShowSuperChat, true),
        ...
        bool(SettingsDataStore.AutoUpdateFollowEnable, false),
        int(SettingsDataStore.AutoUpdateFollowDuration, 30),
        int(SettingsDataStore.UpdateFollowThreadCount, 4),

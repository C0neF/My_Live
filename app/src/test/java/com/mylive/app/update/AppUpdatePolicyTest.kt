...
class AppUpdatePolicyTest {
    ...
    @Test
    fun repositoryUsesReleaseListAndV1StableChannel() {
        ...
        assertTrue(source.contains("majorVersion = 1"))
        assertTrue(source.contains("selectLatestStableReleaseForMajor("))
    }
    ...
    @Test
    fun settingsScreenExposesV1UpdateEntry() {
        ...
        assertTrue(updateSource.contains("v1.x 稳定版"))
    }
